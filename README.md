...
| Hosting | Oracle Cloud Infrastructure (OCI Compute, Always Free) | Requisito del challenge |
...
**🔗 Aplicación funcionando:** `http://<IP_PUBLICA_DE_TU_INSTANCIA>:8501`

*(agrega aquí el link real y una captura de pantalla de la app corriendo en OCI)*

Pasos completos de despliegue documentados en [`DEPLOY_OCI.md`](./DEPLOY_OCI.md).
...
- **FAISS local:** no requiere una base de datos vectorial externa ni
  credenciales adicionales, lo que simplifica el despliegue en una instancia
  pequeña de OCI.
